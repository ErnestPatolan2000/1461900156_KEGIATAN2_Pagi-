...
$q = $link->query("select * from prosesparkir where status='m' or status = 'r'");  
...
?>
	<td>
	<a class="btn btn-warning btn-sm" href="mobil_keluar.php?platnomor=<?php echo $r['platnomor'];?>">Keluar</a>
	</td>
    </tr>
